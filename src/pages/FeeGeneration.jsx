      ...
      <div className="card card-soft p-3 mb-3">
        <div className="row g-2">
          ...
          <div className="col-md-2">
            <select className="form-select" required value={form.group} onChange={e=>setForm({...form,group:e.target.value,courseCode:'',semester:''})}>
              <option value="">Group</option>
              {groups.map(g=> (<option key={g.id} value={g.code}>{g.code}</option>))}
            </select>
          </div>
          <div className="col-md-3">
            <select className="form-select" required value={form.courseCode} onChange={e=>setForm({...form,courseCode:e.target.value,semester:''})}>
          ...
          <div className="col-md-2"><input type="number" className="form-control" required placeholder="Amount" value={form.amount} onChange={e=>setForm({...form,amount:e.target.value})} /></div>
